...
use yaml_rust_next::parser::{Event, EventReceiver, Parser};
use yaml_rust_next::scanner::TScalarStyle;
...
fn test_mapvec_legal() {
    use yaml_rust_next::yaml::{Array, Hash, Yaml};
    use yaml_rust_next::{YamlEmitter, YamlLoader};
